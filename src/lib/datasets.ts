...
export const DATASET_SECTIONS: DatasetSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "split.hr „GIS podatci” — vektorski podaci planova",
        desc: "Gradska stranica navodi ~30 GIS paketa planova (GUP, UPU-i, DPU-i, uklj. Dračevac; ažurirano 2025.) — vjerojatno ZIP sa SHP/DWG datotekama. Jedini poznati izvor pravog vektorskog zoniranja.",
        endpoints: [
          "https://split.hr/strateski-dokumenti/prostorno-planska-dokumentacija/planovi-na-snazi/gis-podatci",
        ],
        format: "arhive (SHP/DWG?)",
        license: "javni gradski dokumenti",
        coverage: "GUP obuhvat — potpuna",
        status: "warn",
        statusLabel: "ručno preuzimanje",
        note: "Poveznice su vezane uz sesiju preglednika — automatsko preuzimanje ne radi, treba ih ručno skinuti.",
      },
      {
        name: "split.hr planska dokumentacija (PDF)",
        desc: "Cjelovita dokumentacija planova: DPU radne zone Dračevac (izmjene do 2024.), UPU Bilice sjever, UPU Bilice II–Mostine, UPU Šine–Vidovac… Kartografski prikazi kao PDF-ovi (1–13 MB), bez georeference.",
        endpoints: [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Hrvatske ceste — javne ceste",
        desc: "Osi javnih cesta (državne/županijske/lokalne) — korisno i za utvrđivanje nadležnosti nad pojedinom cestom.",
        endpoints: [
